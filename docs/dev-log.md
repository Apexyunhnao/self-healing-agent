...
> 记录开发难点、决策时刻、踩坑过程。复盘讲"为什么这么做"时引用。
...
- 交付：CLI（services/status/run/verify/incidents/audit/dashboard-data）+ 单文件 dashboard.html + local_svc 只读监控。
